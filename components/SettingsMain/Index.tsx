...
import { FiDownloadCloud, FiMail, FiPlus } from "react-icons/fi";
...
export default function Index({}: Props) {
  ...
  return (
    <div className="py-11 md:py-9 pl-3 pr-5 w-full">
      <h1 className="text-brand-dark-1 md:text-3xl text-2xl mb-1">Settings</h1>
      <h4 className="md:text-2xl text-brand-grey-2 text-base">
        Manage your team and preferences here.
      </h4>
      <ButtonGroup />

      <div className="mb-4 md:mb-5">
        <h3 className="md:text-lg text-base text-brand-dark-1 font-medium mb-1">
          Payment Method
        </h3>
      ...
      <section>
        <div className="flex justify-between mb-7 mt-8 md:flex-row flex-col">
          <h3 className="text-brand-dark-1 text-lg font-medium mb-2 md:mb-0">
            Billing History
          </h3>
          <button className="flex  gap-2 items-center border px-4 py-2 rounded-lg border-brand-grey-3 max-w-[45%] md:max-w-full">
