...
function MainMenu({ onClick }: Props) {
  ...
  return (
    <>
      <div className="flex w-full border-b md:border-0">
        <div className="pt-2 w-full">
          ...
          <label className="relative block mr-2 md:mr-0">
        ...
        <div
          className=" text-brand-grey-1 md:hidden cursor-pointer bg-brand-grey-2 px-5"
          onClick={onClick}
        >
          <RxCross2 size="20" />
        </div>
